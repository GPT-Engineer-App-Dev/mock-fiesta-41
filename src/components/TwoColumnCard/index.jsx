...
const TwoColumnCard = () => {
  return (
    <motion.div initial="offscreen" whileInView="onscreen" viewport={{ once: true }} className="grid grid-cols-1 gap-10 items-center md:grid-cols-2">
      <motion.div
        variants={{
          offscreen: {
            y: 150,
      ...
      >
        ...
        <ul className="text-base text-primary-400 list-inside list-disc dark:text-neutral-200">
          ...
          <li>Created and developed websites, landing pages, and email templates using HubSpot CMS that are easy for clients to edit and optimized for different devices</li>
      ...
      >
        ...
        <ul className="text-base text-primary-400 list-inside list-disc dark:text-neutral-200">
          <li>Developed and implemented CMS websites utilizing the HubSpot platform, resulting in an efficient and user-friendly experience for clients</li>
          ...
          <li>Achieved the top-rated badge on Upwork within four months of starting as a freelancer, demonstrating exceptional performance and customer satisfaction in delivering high-quality front-end development services.</li>
        </ul>
      </motion.div>
      <motion.div
        variants={{
      ...
      >
        <h6 className="text-2xl font-bold text-primary mb-4 dark:text-white">
          <a href="https://schibsted.com/" target="_blank" className="hover:underline">
            Schibsted
          </a>
          <span className="mt-4 text-xs flex items-center justify-start uppercase text-neutral-600 dark:text-neutral-300">
            <CalendarIcon className=" text-neutral-600 h-4 mr-2 dark:text-neutral-300" />
        ...
        <ul className="text-base text-primary-400 list-inside list-disc dark:text-neutral-200">
          <li>Developed e-commerce websites for Schibsted, a leading media company</li>
          <li>Implemented responsive and user-friendly interfaces using modern front-end technologies</li>
          <li>Collaborated with cross-functional teams to deliver high-quality web experiences</li>
        </ul>
      </motion.div>
    </motion.div>
  );
